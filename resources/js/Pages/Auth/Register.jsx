    ...
    const fetchCities = async (countryCode, stateCode) => {
        try {
            if (countryCode && stateCode) {
                // Check if countryCode and stateCode are not undefined
                ...
                <div className="lg:w-80 md:w-80">
                    ...
                    <form onSubmit={submit}>
                        <div className="max-h-[300px] overflow-y-auto">
                            ...
                            <div className="mt-4">
                                <label className="">Register as a:</label>
                                {roles.map((role) => (
                                    <label
                                        key={role.id}
                                    ...
                                    >
                                        <Checkbox
                                            ...
                                            checked={data.roles.includes(
                                                role.id
                                            )} // Check if role id is included in data.roles array
                                            onChange={(e) => {
                                                const isChecked =
                                                    e.target.checked;
                                                if (isChecked) {
                                                    setData((prevData) => ({
                                                        ...
                                                        roles: [
                                                            ...prevData.roles,
                                                            role.id,
                                                        ], // Add role id to data.roles array
                                                    }));
                                                } else {
                                                    setData((prevData) => ({
                                                        ...prevData,
                                                        roles: prevData.roles.filter(
                                                            (roleId) =>
                                                                roleId !==
                                                                role.id
                                                        ), // Remove role id from data.roles array
                                                    }));
                                                }
                                            }}
                                        />
                            ...
                            <div className="mt-4">
                                <label className="flex items-center">
                                    ...
                                    <span className="ms-2 text-sm text-gray-600">
                                        ...
                                        <Link className="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                            terms of service
                                        </Link>
                                    </span>
                                </label>
                        ...
                        <div className="flex  gap-3 justify-start mt-4">
                            ...
                            <PrimaryButton
                                disabled={
                                    !data.terms_and_conditions || processing
                                }
                            >
                                Register
                            </PrimaryButton>
