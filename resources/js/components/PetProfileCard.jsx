...
const PetProfileCard = ({petName , petType ,petGender,petBreed,parentName,contact,email,petAge, updateImageRoute,imagePath}) => {
    ...
    return (
      ...
      <label htmlFor="imageInput">
        ...
        <img
          ...
          alt=""
          style={{ width: '100%', height: 'auto', maxWidth:'570px', maxHeight:'300px'}}
        />
      </label>
      <input
        id="imageInput"
      ...
      {/* Other pet profile information */}
                ...
                <div class="p-5">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div className="card-small">
                            <h5 className="card-title">{selectedGenderName}</h5>
